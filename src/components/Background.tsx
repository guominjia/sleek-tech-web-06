...
const Background = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      {/* Softer mesh gradient overlay */}
      <div className="absolute inset-0 opacity-30 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-purple-300 via-blue-300 to-transparent"></div>
      ...
      {/* Tech Circuit Lines - lighter blue */}
      <div className="absolute top-0 left-0 w-full h-full opacity-20">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 1920 1080" preserveAspectRatio="xMidYMid slice">
          ...
          <g fill="none" stroke="#60a5fa" strokeWidth="0.8" opacity="0.5">
